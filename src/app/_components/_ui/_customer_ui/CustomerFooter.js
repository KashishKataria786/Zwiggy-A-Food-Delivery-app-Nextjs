...
const CustomerFooter = () => {
  ...
  <div className="max-w-7xl mx-auto px-4 py-20 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 text-sm text-gray-600">
    {/* Brand */}
    <div>
      <h3 className="text-lg font-semibold text-gray-900 mb-3">Zwiggy</h3>
